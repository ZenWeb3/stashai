...
import { Zap, Mail, Lock, User, ArrowRight, Github, Check } from 'lucide-react';
          ...
          <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 sm:p-10 shadow-2xl">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-xs">
                <span className="bg-black/40 px-4 text-gray-500 uppercase tracking-wider">Or sign up with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                {formData.password && (
                  <div className="mt-2 flex items-center gap-2 text-xs">
                    <div className={`flex items-center gap-1 ${passwordLength ? 'text-[#CCFF00]' : 'text-gray-500'}`}>
              ...
              <div className="pt-2">
                <label className="flex items-start gap-3 cursor-pointer group">
                  ...
                  <span className="text-xs text-gray-400 group-hover:text-gray-300 transition-colors">
                    I agree to the{' '}
                    <Link href="/terms" className="text-[#CCFF00] hover:underline">Terms of Service</Link>
                    {' '}and{' '}
                    <Link href="/privacy" className="text-[#CCFF00] hover:underline">Privacy Policy</Link>
                  </span>
                </label>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading || !agreedToTerms || !passwordsMatch || !passwordLength}
            ...
            <p className="text-center text-sm text-gray-400 mt-6">
              ...
              <Link href="/auth" className="text-[#CCFF00] hover:underline font-medium">
                Sign in
              </Link>
            </p>
          </div>
